...
import { addItem ,CartItem,minusItem,removeItem} from "../redux/cartSlice";
...
type CartItemPropsType = {
 ...
 const CartItemBlock : React.FC<CartItemPropsType> = ({id,title,type,size,price,count,imageUrl})=>{
  ...
  const onClickRemove = ()=>{
   if(window.confirm('Are yoe shure you want to remove')){
  ...
  return (
    <div className="cart__item">
              ...
              <div className="cart__item-count">
                <button onClick={onClickMinus} disabled={false} className="button button--outline button--circle cart__item-count-minus">
